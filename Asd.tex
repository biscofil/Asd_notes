...
\lstinputlisting[language=Python]{code/heap_insert.txt}
...
\lstinputlisting[language=Python]{code/kruskal.txt}
...
\lstinputlisting[language=Python]{code/prim.txt}
...
\lstinputlisting[language=Python]{code/init_single_source.txt}

\protect\hypertarget{t.4fa4368bfb7c1d485140ed33f86edf6c298bfda0}{}{}\protect\hypertarget{t.47}{}{}

\lstinputlisting[language=Python]{code/relax.txt}
...
\lstinputlisting[language=Python]{code/dijkstra.txt}
