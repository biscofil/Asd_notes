...
$2+T_{n-1} + T_{n-2},\,\forall n \geq 3$
...
{Sia $x$ un nodo dell'albero radicato $T$ con radice }\includegraphics{images/image83.png}{.}
...
L'array $A[i,\ldots,A.heapSize]$ soddisfa le proprietà di maxHeap tranne una possibile violazione: A{[}i{]} potrebbe essere più grande di A{[}parent(i){]}}
...
{Dati $n$ numeri di $d$ cifre, dove ogni cifra può avere fino a $k$ valori possibili}\textsuperscript{\protect\hyperlink{cmnt16}{{[}p{]}}}{, la procedura ordina correttamente i numeri nel tempo di }\includegraphics{images/image196.png}{~se l'algoritmo stabile utilizzato dalla procedura impiega un tempo }\includegraphics{images/image198.png}

{Dimostrazione:}

{Per ogni iterazione, il costo risulta essere}\includegraphics{images/image198.png}

{Le iterazioni sono d, per un totale di }\includegraphics{images/image196.png}

{Osservazioni:}

{~~~~~~~~Se $k=(n)$ il tempo di esecuzione è }\includegraphics{images/image199.png}

{Inoltre, se $d$ è costante, la complessità è }\includegraphics{images/image149.png}
...
{Cerco di minimizzare la complessità ponendo $r$ grande,
...
Scelgo $r$ piccolo, altrimenti $2^r $domina su $n$.}
...
{$h:U\rightarrow\{0,1,\ldots,m-1\}$, dove $m$ della tabella hash è generalmente molto più piccola della dimensione dello spazio di tutte le chiavi.}
